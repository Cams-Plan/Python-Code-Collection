...
print(travel_log)
            ...
            ## COMMENTS/DECISIONS
            ## 1
            ## I decided to make template dictionary called new to transfer the function parameter data
            # into so it would be in format for appending later.
            ## the values couldn't be blank, so I chose "none" as the value as it made the most contextual 
            # sense, but it could've been any placeholder.
